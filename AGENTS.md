...
- Prisma migration history is out of order (`20250120000001_*` before `20250805173941_init`); fresh DBs may need `prisma db push` until fixed.
- Demo data via `npm run seed:demo` / `scripts/seed-demo.cjs`; demo user emails are `comprador@demo.com` and `representante@demo.com`.
